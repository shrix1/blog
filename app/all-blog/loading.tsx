  ...
  return (
    <main className="w-full flex py-4 px-6 items-center h-[90vh] flex-col gap-5">
      <div className="w-full lg:w-1/2 flex justify-start">
        <Skeleton className="w-40 p-3 text-left loading" />
      </div>

      <div className="w-full lg:w-1/2 flex flex-col lg:flex-row gap-3 ">
        <Skeleton className="w-full lg:w-[70%] p-5 loading" />

        <div className="flex gap-3 w-full loading">
        ...
        .map((_, index) => {
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-2 loading w-full">
